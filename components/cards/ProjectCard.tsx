...
export default function ProjectCard({
  ...
  return (
    <div
      className="
        group bg-neutral-50 border-2 border-stone-950 rounded-3xl p-6 
        flex flex-col md:flex-row items-start md:items-center justify-between
        shadow-md hover:shadow-lg hover:bg-white transition-shadow
      "
    >
      {/* Texto */}
        ...
        >
          {normalizedLinks.map(({ icon: LinkIcon, url }, i) => (
            <a
              ...
              className="
                bg-neutral-50 border-2 border-stone-950 rounded-full 
